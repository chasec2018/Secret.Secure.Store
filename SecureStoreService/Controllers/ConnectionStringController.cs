...
namespace SecureStoreService.Controllers
{
    [AccessKeyAuth]
    [ApiController]
    [Route("ConnectionString/{action}")]
    public class ConnectionStringController : ControllerBase
    {
        private readonly ILogger<ConnectionStringController> Logger;
        private readonly SqlServerRequestHandler SqlRequestHandler;

        public ConnectionStringController(ILogger<ConnectionStringController> _Logger, SqlServerRequestHandler _SqlRequestHandler)
        {
            Logger = _Logger;
